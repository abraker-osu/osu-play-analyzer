...
class DevGraphRhythm(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.__dev_data_select = self.DEV_DATA_T
    ...
    def __get_deviation_data(self, play_data):
        ...
        chunks_x = [   0,   100,       2  ]    # Rhythm,  50 bins max
    ...
    def plot_data(self, play_data):
        ...
        # Colored gradient r->g->b multiple plots at different bpms
        ...
        for bpm in unique_angs:
            ...
            label = f'∠={bpm:.2f}  n={stdevs.shape[0]}  σ={m_dev_y:.2f}  m={m:.5f}±{m_se_95:.5f}  b={b:.2f}±{b_se_95:.2f}'
            print(label)
