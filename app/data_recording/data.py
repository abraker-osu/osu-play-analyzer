...
class RecData():    
    ...
    X_OFFSETS = 15  # How far the pattern is from the center of the note along the x-axis
    Y_OFFSETS = 16  # How far the pattern is from the center of the note along the y-axis
    T_OFFSETS = 17  # How early/late the note was hit
    NUM_COLS  = 18
