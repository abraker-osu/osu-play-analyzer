...
class DataProcessing():
    ...
    def get_difficulty_data(score_data):
        ...
        def __get_note_dt():
            ...
            """
            dt = np.zeros(map_t.shape[0])
            
            dt[0]  = np.inf
            dt[1:] = map_t[1:] - map_t[:-1]  # t1 - t0
        ...
        def __get_dt_dec():
            ...
            """
            dt_dec = np.zeros(map_t.shape[0])

            dt0 = map_t[1:-1] - map_t[:-2]   # t1 - t0
            dt1 = map_t[2:] - map_t[1:-1]    # t2 - t1
